...
const BADGES = [
  ...
  { key: 'beginner',      label: 'Beginner',         condition: g => g.quizzesPassed >= 1 },
  { key: 'eco_learner',   label: 'Eco Learner',      condition: g => g.quizzesPassed >= 5 },
  { key: 'waste_warrior', label: 'Waste Warrior',    condition: g => g.quizzesPassed >= 10 },
  { key: 'quiz_master',   label: 'Quiz Master',      condition: g => g.quizzesPassed >= 15 },
