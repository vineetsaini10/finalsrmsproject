...
export default function SettingsPage() {
  ...
  const [notifications, setNotifications] = useState({
    urgentComplaints: true, dailyReport: true, hotspotAlert: true, weeklyDigest: false,
  })
      ...
      <div className="space-y-6 max-w-3xl">
        ...
        <SectionCard title="Account Information">
          <div className="p-5 space-y-4">
            ...
            <p className="text-xs text-slate-400">To update your profile details, contact your system administrator.</p>
          </div>
        </SectionCard>
              ...
              <div key={pref.key} className="flex items-center justify-between p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors flex-shrink-0
                    ${notifications[pref.key] ? 'bg-blue-600' : 'bg-slate-300'}`}
                >
          ...
          <div className="p-5">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {[
                ...
                { label: 'AI Service',   value: 'FastAPI'     },
